...
Running `fresnel mcp` directly prints a readiness message and then waits for JSON-RPC on stdin; this is normal. Cursor-launched MCP sessions receive live progress notifications during planning, implementation, retries, and validation.
